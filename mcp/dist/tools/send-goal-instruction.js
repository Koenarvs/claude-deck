...
export const SendGoalInstructionInputSchema = z.object({
    ...
    from_goal_id: z
        .string()
        .optional()
        .describe('ID of the sending goal. If omitted, infer from the current session\'s goal_id.'),
});
/**
...
export async function sendGoalInstruction(client, input) {
    ...
    const message = await client.sendGoalInstruction(fromGoalId, input.target_goal_id, {
