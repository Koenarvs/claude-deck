...
export async function scheduleTask(
  ...
  } = { title: input.goal_template.title, cwd: input.goal_template.cwd };
  if (input.goal_template.model !== undefined) tmpl.model = input.goal_template.model;
  if (input.goal_template.initialPrompt !== undefined) tmpl.initialPrompt = input.goal_template.initialPrompt;
  if (input.goal_template.tags !== undefined) tmpl.tags = input.goal_template.tags;
